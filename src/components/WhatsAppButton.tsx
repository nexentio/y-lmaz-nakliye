...
export default function WhatsAppButton() {
  ...
  // Güzel ve profesyonel bir mesaj metni
  const message = encodeURIComponent(
    "Merhaba! Yılmaz Nakliyat hizmetleriniz hakkında bilgi almak istiyorum. " +
    "Taşımacılık ihtiyacım için teklif alabilir miyim? " +
    "Teşekkürler! 🙏"
  );
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        {/* Button */}
        <div className="relative bg-[#25D366] hover:bg-[#20BA5A] rounded-full p-4 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 group-hover:rotate-12">
          <svg
            width="32"
            height="32"
            viewBox="0 0 24 24"
